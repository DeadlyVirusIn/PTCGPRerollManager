...
function text_lowTension(client){
    ...
    getRandomStringFromArray([
        ...
        `Ce serait pas un gp dud ca comme même ?`,
        `Aïe aïe aïe`,
        `Y\'a R ${emoji_Copium}`]),
    getRandomStringFromArray([
...
function text_mediumTension(client){
    ...
    getRandomStringFromArray([
        ...
        `Oh Bonne Mère j'espère que c'est le dernier /miss celui la putaing cong`,
...
function text_highTension(client){
    ...
    getRandomStringFromArray([
        ...
        `C'est ciao.`,
        `Oh pinaise un gp invalide Marge file moi un donut sucré au sucre`,
        `Tout espoir est perdu ${emoji_Sadge}`,
        `Le prochain GP c'est le bon ${emoji_Copium}`,
        `Quoient... Encore un gp dead...`,
        `Mais nan c’est pas vrai ? C'est un gp dead ca ?? Ah bah j’suis ravi !!`,
