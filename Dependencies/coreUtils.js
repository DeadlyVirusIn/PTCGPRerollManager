...
async function getEnhancedSelectedPacksEmbedText(client, activeUsers) {
    var packCounter = {
        ...
        TL_Arceus: 0,
        SR_Giratina: 0,
        SM_Solgaleo: 0, // Added for Solgaleo
        SM_Lunala: 0    // Added for Lunala
    };
    ...
    var packRollers = {
        ...
        TL_Arceus: [],
        SR_Giratina: [],
        SM_Solgaleo: [], // Added for Solgaleo
        SM_Lunala: []    // Added for Lunala
    };
    ...
    for (const forumId of packForums) {
        ...
        try {
            ...
            for (let thread of activeThreads.threads.values()) {
                ...
                else if (forumId === channelID_SolgaleoVerificationForum) packType = "Solgaleo"; // Added for Solgaleo
                else if (forumId === channelID_LunalaVerificationForum) packType = "Lunala";     // Added for Lunala
